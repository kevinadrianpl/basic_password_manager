...
frame = Frame(root, bg="#8c8674", bd=3)
...
#Create the table structure for displaying data
...
def submit():
    ...
    if app_name.get()!="" and url.get()!="" and email_id.get()!="" and password.get()!="":
        ...
        # After the data is entered, clear the text boxes
        ...
        messagebox.showinfo("Alert", "Please fill all details in!")
        conn.close()
...
def update():
    ...
    if(t!=""):
        ...
        edit.minsize(390, 140)
        edit.maxsize(390, 140)
        ...
        email_id_label_edit = Label(edit, text="Email Address:")
...
#Create the function to save updated records
def change():
    #connect to database
    conn = sqlite3.connect("passmanager.db")
    cursor = conn.cursor()
    ...
    if app_name_edit.get()!="" and url_edit.get()!="" and email_id_edit.get()!="" and password_edit.get()!="":
        ...
        # After the data is entered, clear the text box and destroy the secondary window
...
#Create the function to hide records
def hide():
    query_label['text'] = ""
